...
"}")
        ...
        self.label.setGeometry(QtCore.QRect(26, 32, 271, 181))
    ...
    def retranslateUi(self, Form):
        ...
        self.label.setText(_translate("Form", "<html><head/><body><p align=\"center\"><span style=\" font-size:12pt; font-weight:600;\">EgyBest Film Downlaod</span></p><p align=\"center\"><br/></p><p><span style=\" font-size:10pt; font-weight:600;\">Developed By:</span><span style=\" font-style:italic;\">Ahmed Hanfy Bekheet</span></p><p><span style=\" font-size:10pt; font-weight:600;\">Version: </span>1.0.0v</p><p><span style=\" font-size:10pt; font-weight:600;\">Source Code: </span><span style=\" font-style:italic;\"><a href=\"https://github.com/ahanfybekheet/egybest\">github</a></span><span style=\" font-size:10pt; font-weight:600;\"/><br/></p></body></html>"))
